...
import com.pravinsingh.foodie1.Adapters.CartAdapter;
...
public class CartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList<CartModule> list3 = new ArrayList<>();
        CartAdapter cartAdapter = new CartAdapter(list3,getContext());
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snapshot1 : snapshot.getChildren()) {
                    CartModule cartModule = snapshot1.getValue(CartModule.class);
                    list3.add(cartModule);
                }
